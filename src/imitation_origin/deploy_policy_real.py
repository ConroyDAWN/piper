...
from imitation_origin.playTrajectory_pyagxarm_ik_movej import (  # noqa: E402
    PiperUrdfIkSolver,
    clip_joints,
    get_joint_limits,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--ckpt",
        default="/home/flowing/piper/data/trained_models/piper_4_2_1/piper_bc_rnn_no_vision_3_28_1/20260402102848/models/model_epoch_310.pth",
...
def main() -> int:
    ...
    try:
        for step in range(args.max_steps):
            ...
            with torch.no_grad():
                ...
                for obs_mode in mode_candidates:
                    ...
                    try:
                        ...
                        print("[DEBUG] obs_mode =", obs_mode)
                        print("[DEBUG] policy return type =", type(action_norm))
                        if hasattr(action_norm, "shape"):
                            print("[DEBUG] policy return shape =", action_norm.shape)
                        if isinstance(action_norm, dict):
                            print("[DEBUG] policy return keys =", action_norm.keys())
                        if step == 0:
            ...
            print(f"[DEBUG] action_norm = {action_norm}")
            ...
            print(f"[DEBUG] curr_pose = {curr_pose}")
            print(f"[DEBUG] target_pose = {target_pose}")
